...
namespace aisaac {
    ...
    public:
        AisaacXBeeBase() : frameID(0x0), xbeeOptions(0x0) {}
        ...
        void constructXBeeFrame(std::vector<unsigned char>&, std::vector<unsigned char>&);
    ...
    protected:
        ...
        void constructTransmitRequestFrame(std::vector<unsigned char>&, std::vector<unsigned char>&);
    };
}